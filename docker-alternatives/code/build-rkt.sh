...
acbuild set-name perylemke/jabex # Determina um nome a nossa imagem
acbuild copy hello-rkt /bin/jabex # Copiando o binário para a imagem
acbuild set-exec /bin/jabex # Deixando como executável
